...
from pip._vendor.variantlib.plugins.py_backends import AutoInstallBackend
from pip._vendor.variantlib.plugins.py_backends import PipBackend
from pip._vendor.variantlib.plugins.py_backends import UvBackend
